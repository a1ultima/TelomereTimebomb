...
print(H_timeseries)
    ...
    plt.stackplot(range(1,20), H_timeseries)
...
plt.legend()
plt.show()
#when good plot generated add: plt.savefig("../plots/Allele_Telomere_length_distribution_recessive_lethal_recessive_shortening.png", dpi = 600)
#, label = ["HT0", "HT1", "HT2", "HT3"]
